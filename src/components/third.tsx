...
const Third = () => {
	...
	return (
		...
		>
			...
			>
				<Sparkles className='sparkle absolute top-20 left-1/4 text-red-200 opacity-30' size={16} />
				<Sparkles className='sparkle absolute top-40 right-1/3 text-blue-200 opacity-25' size={12} />
				<Sparkles className='sparkle absolute bottom-32 left-1/3 text-purple-200 opacity-30' size={14} />
				<Sparkles className='sparkle absolute bottom-20 right-1/4 text-pink-200 opacity-25' size={18} />
			</div>
				...
				>
					...
					<motion.div variants={itemVariants}>
						<ContactItem
							icon={MapPin}
							title='Dirección'
							content='Cra 8 #8A, Chinchiná, Caldas'
							delay={0.2}
